      ...
      <div className="bg-purple-900 py-20 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-purple-200 text-lg max-w-2xl mx-auto">
            Expert-led courses designed to fast-track your career in consulting
                  ...
                  <div className="mt-auto pt-4 border-t border-gray-50">
                    <div className="flex items-center justify-between text-sm text-gray-500 mb-4">
                      <div className="flex items-center gap-2">
                        <Users size={16} />
                        <span>
                          {course.instructor?.name || "Royal Hire Team"}
                        </span>
                      </div>
                    ...
                    <Link
                      ...
                      className="block w-full py-3 text-center bg-gray-900 text-white font-bold rounded-xl hover:bg-purple-700 transition-colors"
                    >
                      View Program
                    </Link>
                  </div>
